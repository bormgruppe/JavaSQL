...
public class MySqlLimitQuery implements IQuery {
    ...
    public MySqlLimitQuery(MySqlQueryCreator creator, IQuery parent, int limit) {
        if (limit <= 0) {
    ...
    public MySqlLimitQuery(MySqlQueryCreator creator, IQuery parent, int start, int stop) {
        if (start <= 0 || stop <= 0) {
